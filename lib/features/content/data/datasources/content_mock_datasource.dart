...
// Mock mode duplicates English into de/sq (same placeholder approach as
// albmap-backend/src/db/seed.js) rather than maintaining a second/third
// translation of every mock string — mock mode is for offline dev/UI
// work, not for verifying translated copy.
const AboutContentModel _kAboutUsEn = AboutContentModel(
...
const LegalPageModel _kPrivacyPolicyEn = LegalPageModel(
...
const LegalPageModel _kTermsConditionsEn = LegalPageModel(
...
class ContentMockDataSource implements ContentDataSource {
  static const SiteContentModel _content = SiteContentModel(
    aboutUs: {'en': _kAboutUsEn, 'de': _kAboutUsEn, 'sq': _kAboutUsEn},
    ...
    privacyPolicy: {'en': _kPrivacyPolicyEn, 'de': _kPrivacyPolicyEn, 'sq': _kPrivacyPolicyEn},
    termsConditions: {'en': _kTermsConditionsEn, 'de': _kTermsConditionsEn, 'sq': _kTermsConditionsEn},
  );
